...
<p align="center">
  ...
  <a href="https://colab.research.google.com/github/heraclitus0/TAD-IDS/blob/main/Addressing_Temporal_Fragility_in_Network_Intrusion_Detection_via_Structured_Feature_Modeling.ipynb"><img src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open In Colab"></a>
</p>
...
Standard NIDS architectures process network features as a monolithic vector, failing to account for semantic relationships between packet headers, payloads, and timing metadata. Consequently, models often overfit to transient noise specific to the training window.
...
<p align="center">
  <img src="figs/fig1_reality_gap.png" width="800" alt="Reality Gap Performance Analysis">
  <br>
  <em>Figure 1: Comparison of performance decay across temporal shifts (Baseline vs. TAD-IDS).</em>
</p>
...
* **Temporal Aggregator**: A Multi-Head Attention (MHA) layer that computes inter-dependencies between feature domains, suppressing brittle feature sets that exhibit high variance across temporal shifts.
